...
$subject = "Message from MurphysMountainGrill.com Website";
...
<head>
	...
	<style type="text/css">
		...
		body {
		    ...
		    margin: 0;
		    color: #fff;
		    background: url(_images/murphys-mountain-grill-logo.png) fixed repeat;
		}
		.flex-container {
		    height: 100%;
		    padding: 0;
...
<!--     <div class="row">  -->
        <div class="flex-item">
        	...
        	<p><a href="http://www.murphysmountaingrill.com">Back</a></p>
        </div>
<!--     </div> -->
</div>
